...
public class ValidationItemControllerV2 {
    ...
    @InitBinder             //validator 분리 2 - 컨트롤러가 호출될때마다 검증기가 먼저 호출이 된다.
...
//    @PostMapping("/add")        //validator 분리한 코드
    public String addItemV5(@ModelAttribute Item item, BindingResult bindingResult,
      RedirectAttributes redirectAttributes, Model model) {

        itemValidator.validate(item, bindingResult);        //분리한 validator 호출
    ...
    public String addItemV6(@Validated @ModelAttribute Item item, BindingResult bindingResult,
      RedirectAttributes redirectAttributes, Model model) {//애노테이션 하나 추가로 위와 똑같이 작동.
